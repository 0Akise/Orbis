...
int main() {
    ...
    canvas_hud
        ...
        .DrawText("title", font_basic, 20, {10, 10}, 10, sf::Color::White, "Button Test");
    ...
    button_normal
        ...
        .DrawText("btn_text", font_basic, 16, {30, 15}, 10, sf::Color::White, "Click Me!");
    ...
    button_styled
        ...
        .DrawText("btn_text", font_basic, 16, {25, 15}, 10, sf::Color::White, "Styled Button");
    ...
    button_counter
        ...
        .DrawText("btn_text", font_basic, 16, {30, 15}, 10, sf::Color::White, "Count: 0");
